# LOAD PACK's and data ----------------------------------------------------
#control shft r comment onto comenta poniendo las rayas esas
# conntrol sht c comment comenta lineas a la vez
#alt+- insertes <-
#ctrl al enter   sen non-R code to terminal
#control shft m  %>%
